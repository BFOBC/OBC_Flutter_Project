...
class _OpenStreetMapScreenState extends State<CourierMap>
 ...
 /* List<Marker> _markers = [
  ...
  void _onSearchAirport(String query) {
    // Filter countries by matching the query
    setState(() {
      _searchText = query; // Update the search text
      _suggestedCountries = countryLocations.keys
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return ConfirmLocationChangeDialog(
          onConfirm: () {
            setState(() {
              _selectedLocation = countryLocations[countryCode]!;  // Update the location
